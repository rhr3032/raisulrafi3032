    ...
    <div class="container-lg">
      <div class="common-banner-content">
        <div class="mw-460">
          ...
          <div class="d-flex ga-6">
            ...
            <p class="text-white text-subtitle-1 mb-0">
              <span class="opacity-70">I craft</span>
              <span class="text-primary opacity-100"> intuitive user experiences </span>
              <span class="opacity-70"
                >that solve real problems and create delightful digital products users love</span
              >
            </p>
          </div>
        </div>
        ...
        <div class="d-flex flex-md-row flex-column ga-5 align-md-end align-start mt-md-6 mt-3">
          <h1 class="text-white text-h1 font-weight-bold mb-0">About me</h1>
          <SharedBigBadge />
        </div>
      </div>
    </div>
