    ...
    <div class="container-lg">
      <v-row>
        ...
        <v-col cols="12" xl="4" class="position-relative">
          <SharedLeftSideDarkHeading number="04" title="Experience" />
          <div class="d-flex flex-column ga-6 mt-6 mw-xl-430">
            <h2 class="text-h2 text-dark">Why choose me</h2>
            <p class="text-subtitle-1 text-dark opacity-70">
              With 4+ years of UI/UX design experience, I combine user research,
              design thinking, and visual expertise to create products that users love and businesses value.
            </p>
          </div>
        </v-col>
          ...
          <v-row>
                ...
                >
                  <div>
                    ...
                    <p class="text-subtitle-1 mt-3">
                      Exceptional UI/UX design that transformed our product. 
                      The user flows are intuitive and the interface is beautiful.
                    </p>
                  </div>
                  <div class="pt-16">
                    <div>
                      <h2 class="text-h2">100%</h2>
                      <small
                        class="text-secondary opacity-70 text-subtitle-2 font-weight-regular"
                        >Client satisfaction rate</small
                      >
            ...
            <v-col cols="12" md="4" class="d-flex flex-column">
              ...
              <div class="mt-5 bg-secondary pa-7">
                <h2 class="text-h2 text-white">50+</h2>
                <small
                  class="text-white opacity-70 text-subtitle-2 font-weight-regular"
                  >Successful UI/UX projects delivered</small
                >
            ...
            <v-col cols="12" md="4" class="d-flex">
              ...
              >
                <div class="pb-4">
                  <h2 class="text-h2">15+</h2>
                  <small
                    class="text-dark text-subtitle-1 font-weight-regular"
                    >Clients served across industries</small
                  >
                </div>
                <div class="pt-16">
                  <div>
                    <Logo />
                    <p class="text-subtitle-1 mt-3">
                      4+ years of experience creating user-centered designs
                      for startups and established companies across various sectors.
                    </p>
                  </div>
                </div>
