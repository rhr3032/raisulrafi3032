        ...
        <v-col cols="12" lg="8">
          <div class="d-flex flex-column ga-11">
            <SharedCommonHeading
              ...
              subtitle="Real experiences from satisfied clients—discover how my UI/UX design solutions have helped transform products and elevate user experiences."
            />
          </div>
        </v-col>
      </v-row>
        ...
        <v-col cols="12" lg="3" class="d-flex">
          ...
          >
            <div class="d-flex flex-column ga-6">
              ...
              <h4 class="text-h4">
                The app redesign was exceptional. User flows are intuitive and the interface is beautifully crafted!
              </h4>
            </div>
            <div class="pt-12">
        ...
        <v-col cols="12" lg="6" class="d-flex">
          ...
          >
            <div class="d-flex flex-column ga-6">
              ...
              <h4 class="text-h4">
                From wireframes to final design, the attention to detail and user-centric approach delivered outstanding results!
              </h4>
