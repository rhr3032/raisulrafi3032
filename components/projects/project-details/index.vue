  ...
  <div class="bg-darkgray">
    ...
    <div class="container-lg">
      ...
      <div class="d-flex flex-md-row flex-column ga-10 mt-10">
        ...
        <div class="pr-md-10 pr-4 border-e">
          <p class="text-subtitle-2 text-dark" :class="$vuetify.theme.global.name.value === 'light' ? 'opacity-70' : 'opacity-85'">Raised</p>
          <div class="d-flex ga-2 mt-2">
            <span class="text-subtitle-1 font-weight-medium">{{
              post.raised
            }}</span>
        ...
        <div class="">
          <p class="text-subtitle-2 text-dark" :class="$vuetify.theme.global.name.value === 'light' ? 'opacity-70' : 'opacity-85'">Website</p>
          <div class="d-flex ga-2 mt-2">
            <span class="text-subtitle-1 font-weight-medium"
              >https://nuysdev.netlify.app/</span
            >
          </div>
        </div>
      </div>
